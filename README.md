<!-- mcp-name: io.github.CSOAI-ORG/time-tracker-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/time-tracker-ai-mcp.html)
...
```json
{
  "mcpServers": {
    "time-tracker-ai-mcp": {
      "command": "uvx",
      "args": ["time-tracker-ai-mcp"]
    }
  }
}
```

Or: `pip install time-tracker-ai-mcp` then run the `time-tracker-ai-mcp` command (stdio transport).
